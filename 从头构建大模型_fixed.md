...
![图1.7 特殊标记<|endoftext|>用于关联多个独立样本](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/5ff94008d0df8d09-image.png)
...
![图1.9 预测下一个词](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/2b0857df58a1a090-image-2.png)
...
![图1.11 数据集样例](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/bfa2fc9e5df69a94-image-4.png)
...
![图1.12 Embedding层的位置](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/8856ac32ef97e7e3-image-5.png)
...
![图2.2 RNN架构下的翻译任务](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/5e7cb8f1beb1a8db-image-26.png)
...
![图2.7 计算上下文向量](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/378700b4a9412b75-image-16.png)
...
![图2.9 计算注意力得分](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/ba5ca211e79954b8-image-18.png)
...
![图2.11 计算上下文向量](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/65becf615abac6c8-image-20.png)
...
![图3.3 LLM的预测流程](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/38991e3e22e78ddf-image-40.png)
...
![图3.4 层归一化示例](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/d8f959a5b58cb41d-image-30.png)
...
1.  信息容量的增加：首先将维度从emb_dim扩大到4 * emb_dim，维度扩大提供了更丰富的表示空间，可以捕获更多数据中的模式和关系。

1.  非线性变换：在扩大维度后应用GELU激活函数，引入非线性变换。如果没有这个扩展+激活函数的步骤，整个前馈网络就只能进行线性变换了。

1.  信息过滤与压缩：第二个线性层将维度重新压缩回emb_dim，可以看作是对扩展维度中学到的特征进行过滤和提炼。

1.  计算效率与参数共享：维度扩展后的计算虽然增加了计算量，但在实践中证明这种“先扩展后压缩”的设计对于学习复杂特征很有效。同时保持了外部接口的一致性。

![图3.6 前向网络示例](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/6add5c1515eb7515-image-32.png)

![图3.7 瓶颈结构](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/dc06e7654f097e2d-image-33.png)
...
![图3.8 快捷连接示例](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/3bc2c79b58faf4bd-image-34.png)

### 代码示例：快捷连接

1.  保留各层的原始输入。

1.  各层处理后的输出，与原始输入相加后输出，实现快捷连接。
...
![图3.9 Transformer模块](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/9a3af519ee0950a0-image-35.png)
...
![图3.10 GPT-2模型](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/38ab8f4d1b5409c0-image-36.png)

### 代码示例：124M的GPT-2模型

1.  文本向量化后（token embedding+position embedding）作为输入。

1.  Dropout层，对Embedding进行随机丢弃。

1.  重复堆叠12个transformer模块。

1.  归一化层。

1.  输出层，维度由词表大小决定，此处为50257。
...
![图3.11 生成下一个词示意](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/3f5549400501264c-image-37.png)

![图3.12 生成下一个词详解](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/ac74df4b865dd861-image-59.png)

![图3.13 生成多个词的过程示意](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/282587045c1c6e5b-image-58.png)

### 代码示例：生成下一个词

1.  获取上一个阶段的输出token IDs，或原始的输入token IDs。

1.  GPT-2模型预估下一个token ID，只需要取最后一个token的输出。

    1.  因为在因果注意力机制里，只有最后一个token包含有全部的输入信息。

1.  计算各个词的生成概率，并取最大值作为输出，拼接到输出中。

    1.  一般来讲，LLM会通过温度系数和top_p参数等，对模型的生成确定性和多样性进行调整。
...
![图4.1 该部分的内容介绍](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/b804bd65e739c441-image-45.png)
...
![图4.2 最大化目标token的概率](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/1eaa02619de72988-image-46.png)

![图4.3 交叉熵损失计算流程](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/0f267bf2d95ad802-image-47.png)
...
1.  与交叉熵损失的关系
    ...
    1.  交叉熵损失衡量的是模型预测的概率分布与真实标签（下一个词）的差异。损失越小，表示预测越接近真实情况。

    1.  取指数将损失值转换回一个更直观的、与“选项数量”相关的尺度。

1.  有效选项数 (Effective Number of Choices)

    1.  **困惑度可以被理解为模型在预测下一个词时，平均下来认为有多少个同样可能的词可以选择**。

    1.  例如，如果一个模型对于某个测试集的困惑度是 10，这大致意味着，模型在预测序列中的下一个词时，其不确定性等同于从 10 个可能的词中均匀随机地选择一个。

    1.  困惑度越低，表示模型对于下一个词的预测越确定，有效的选项数就越少。理想情况下，**如果模型能完美预测（给正确词 100% 概率），困惑度就是 1**。
...
1.  `calc_loss_loader()`用于计算数据集的损失，用于评估模型训练效果。
...
![图4.4 模型训练流程](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/63b772eaeec96509-image-48.png)
...
1.  分轮次（epoch）
    ...
    1.  分批次（batch）
        ...
        1.  打印训练集和验证集上的loss表现，用于追踪训练效果。

    1.  测试模型的文本生成效果，直观查看模型能力。
...
![图4.5 损失变化图](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/149102f32f1a385e-image-49.png)
...
![图4.6 学习率变化曲线](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/e0f80cad648b0a7f-image-50.png)
...
![图4.7 学习率预热+余弦衰减的学习率变化](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/bf43fb8d6acf0f69-image-51.png)
...
![图4.8 不同温度系数下的概率分布](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/5acec2288831031b-image-52.png)
...
![图4.9 Top-k采样示例](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/fc338eb98fb8d6b0-image-53.png)
...
![图4.10 GPT2 VS Llama2/3](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/34e28c6913cddd6e-image-54.png)
...
1.  更新激活函数，用SiLU代替GELU。

1.  更新前向网络模块，引入门控机制。

1.  更新位置编码，替换为旋转位置编码（RoPE）。
...
Llama2采用SiLU（Sigmoid Linear Unit）作为激活函数，而非 GELU。SiLU 也被称为Swish 函数，其计算公式为<img src="https://www.zhihu.com/equation?tex=%5Ctext%7Bsilu%7D%28x%29%20%3D%20x%20%5Ccdot%20%5Csigma%28x%29" alt="\text{silu}(x) = x \cdot \sigma(x)" class="ee_img tr_noresize" eeimg="1">，其中<img src="https://www.zhihu.com/equation?tex=%5Csigma%28x%29" alt="\sigma(x)" class="ee_img tr_noresize" eeimg="1">为logistic sigmoid函数。
...
Llama2模型在前向网络模块中，引入了基于SiLU的门控线性单元（Gated Linear Unit, GLU），称为SwiGLU，计算公式为：<img src="https://www.zhihu.com/equation?tex=%5Ctext%7BSwiGLU%7D%28x%29%20%3D%20%5Ctext%7BSiLU%7D%28%5Ctext%7BLinear%7D_1%28x%29%29%20%2A%20%28%5Ctext%7BLinear%7D_2%28x%29%29" alt="\text{SwiGLU}(x) = \text{SiLU}(\text{Linear}_1(x)) * (\text{Linear}_2(x))" class="ee_img tr_noresize" eeimg="1">。其中：

-   <img src="https://www.zhihu.com/equation?tex=%5Ctext%7BLinear%7D_1" alt="\text{Linear}_1" class="ee_img tr_noresize" eeimg="1"> 和 <img src="https://www.zhihu.com/equation?tex=%5Ctext%7BLinear%7D_2" alt="\text{Linear}_2" class="ee_img tr_noresize" eeimg="1"> 为两个线性变换层。

-   <img src="https://www.zhihu.com/equation?tex=%2A" alt="*" class="ee_img tr_noresize" eeimg="1">表示按元素（element-wise）乘法。

-   第三个线性层<img src="https://www.zhihu.com/equation?tex=%5Ctext%7BLinear%7D_3" alt="\text{Linear}_3" class="ee_img tr_noresize" eeimg="1">在该门控激活之后应用
...
1.  用了适配更长的上下文，RoPE 的基础值<img src="https://www.zhihu.com/equation?tex=%5Ctext%7Bbase%7D" alt="\text{base}" class="ee_img tr_noresize" eeimg="1">从 10000 提高至 500000，公式<img src="https://www.zhihu.com/equation?tex=%5CTheta%20%3D%20%5Cleft%5C%7B%5Ctheta_i%20%3D%20%5Ctext%7Bbase%7D%5E%7B%5Cfrac%7B-2%28i-1%29%7D%7Bd%7D%7D%2C%20i%20%5Cin%20%5Cleft%5B1%2C%202%2C%20...%2C%20d/2%5Cright%5D%5Cright%5C%7D" alt="\Theta = \left\{\theta_i = \text{base}^{\frac{-2(i-1)}{d}}, i \in \left[1, 2, ..., d/2\right]\right\}" class="ee_img tr_noresize" eeimg="1">。

    1.  增&#x5927;**<img src="https://www.zhihu.com/equation?tex=%5Ctext%7Bbase%7D%5C%5C" alt="\text{base}\\" class="ee_img tr_noresize" eeimg="1">**&#x4F7F;得频率（旋转角度）在维度上的衰减更缓慢，意味着高维度的旋转角度比以前更大（本质上是对频率的解压缩）。 &#x20;
...
![图4.11 GQA示例](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/2a3aa21958774ed3-image-55.png)

##### 代码示例：GQA

1.  此处，还引入了SharedBuffers类，用于在Transformer模块中复用`mask`、`cos` 和 `sin`张量，以提高计算效率。 &#x20;

1.  GQA相比MHA，在计算的时候需要对KV进行重复扩充（通过`torch.repeat_interleave()`实现），以满足矩阵计算的维度要求。
...
1.  引入了权重共享，类似GPT2，输入和输出共享Embedding权重参数，从而提高效率。

1.  RoPE的参数调整，重新缩放因子（RoPE Rescaling Factor）增大。

![图4.12 Llama31和Llama32的区别](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/96250279a6f70ab9-image-56.png)
...
![图5.1 分类微调示例](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/31d6fbac715dc285-image-57.png)

![图5.2 指令微调示例](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/01f6b6f552479872-image-60.png)
...
1.  数据集随机划分为训练集、验证集、测试集。

![图5.3 分类数据处理流程](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/d6106594071b9285-image-61.png)

![图5.4 分类数据样本示例](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/ea0cc9efc8db3402-image-62.png)
...
![图5.5 训练损失](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/198fa3a642433bf5-image-63.png)
...
如下图所示，假设模型中，有一层的参数量较多，对应的权重矩阵为<img src="https://www.zhihu.com/equation?tex=W" alt="W" class="ee_img tr_noresize" eeimg="1">，反向传播时权重更新为<img src="https://www.zhihu.com/equation?tex=W_%5Ctext%7Bupdated%7D%3DW%2B%5CDelta%7BW%7D" alt="W_\text{updated}=W+\Delta{W}" class="ee_img tr_noresize" eeimg="1">，LoRA提供了一种更高效的方式来更新权重，令<img src="https://www.zhihu.com/equation?tex=%5CDelta%7BW%7D%5Capprox%20AB" alt="\Delta{W}\approx AB" class="ee_img tr_noresize" eeimg="1">，其中<img src="https://www.zhihu.com/equation?tex=A" alt="A" class="ee_img tr_noresize" eeimg="1">和<img src="https://www.zhihu.com/equation?tex=B" alt="B" class="ee_img tr_noresize" eeimg="1">是两个参数量较小的权重矩阵，权重更新为<img src="https://www.zhihu.com/equation?tex=W_%5Ctext%7Bupdated%7D%3DW%2BAB" alt="W_\text{updated}=W+AB" class="ee_img tr_noresize" eeimg="1">。

LoRA的另一个优化在于，可以将LoRA的权重和原模型的权重分开存储。实际上，应用LoRA意味着我们完全不需要修改预训练模型的权重（仅需要更新矩阵<img src="https://www.zhihu.com/equation?tex=A" alt="A" class="ee_img tr_noresize" eeimg="1">和<img src="https://www.zhihu.com/equation?tex=B" alt="B" class="ee_img tr_noresize" eeimg="1">），因此，我们也可以动态地应用微调后的LoRA矩阵。

![图5.6 LoRA权重更新](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/4818905e38c408cb-image-64.png)
...
![图5.7 损失变化趋势](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/37c0faad634fc68b-image-73.png)
...
![图6.1 指令遵循示例-EN](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/1f46297b83a7bdde-image-74.png)

![图6.2 指令遵循示例-CN](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/2307c509148e3691-image-70.png)
...
![图6.3 指令微调的数据格式](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/e695d988e0129610-image-72.png)
...
1.  使用特殊token ID替换部分填充token。

    1.  在训练时，会忽略token ID为-100的目标token的损失。

    1.  相比预训练，新增的处理步骤。

![图6.4 指令微调数据处理流程](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/fba47bd1d1b37c5b-image-71.png)

![图6.5 忽略指令部分的损失（下述代码未实现）](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/400836fc38281565-image-68.png)
...
![图6.6 训练损失变化](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/40abc1341fcd9c70-image-69.png)
...
-   使用参考策略<img src="https://www.zhihu.com/equation?tex=%CF%80_%7Bref%7D" alt="π_{ref}" class="ee_img tr_noresize" eeimg="1">来防止策略过度偏离原始模型。

![图6.7 用户咨询购买笔记本电脑建议时LLM的两种回答](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/ca9f62752bce9276-image-65.png)

![图6.8 DPO的核心思想及其优化过程](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/e5014be4bf88b73f-image-66.png)

对模型训练来说，最重要的是损失设计，DPO的损失函数如下：

-   <img src="https://www.zhihu.com/equation?tex=%5Cpi_%7B%5Ctheta%7D" alt="\pi_{\theta}" class="ee_img tr_noresize" eeimg="1">代表策略（Policy），该术语来源于强化学习，在DPO中，它表示我们要优化的LLM。

-   <img src="https://www.zhihu.com/equation?tex=%5Cpi_%7Bref%7D" alt="\pi_{ref}" class="ee_img tr_noresize" eeimg="1">是参考模型（Reference LLM），通常是优化前的原始 LLM，在训练开始前，<img src="https://www.zhihu.com/equation?tex=%5Cpi_%7B%5Ctheta%7D" alt="\pi_{\theta}" class="ee_img tr_noresize" eeimg="1">和<img src="https://www.zhihu.com/equation?tex=%5Cpi_%7Bref%7D" alt="\pi_{ref}" class="ee_img tr_noresize" eeimg="1">通常是相同的。

-   <img src="https://www.zhihu.com/equation?tex=%5Cbeta" alt="\beta" class="ee_img tr_noresize" eeimg="1">是控制<img src="https://www.zhihu.com/equation?tex=%5Cpi_%7B%5Ctheta%7D" alt="\pi_{\theta}" class="ee_img tr_noresize" eeimg="1">和参考模型<img src="https://www.zhihu.com/equation?tex=%5Cpi_%7Bref%7D" alt="\pi_{ref}" class="ee_img tr_noresize" eeimg="1">之间KL散度的超参数，增大<img src="https://www.zhihu.com/equation?tex=%5Cbeta" alt="\beta" class="ee_img tr_noresize" eeimg="1">会加大两个模型之间的对数概率差异对损失函数的影响，这意味着模型会更倾向于偏离参考模型的行为，反之，当<img src="https://www.zhihu.com/equation?tex=%5Cbeta" alt="\beta" class="ee_img tr_noresize" eeimg="1">减小时，模型会更倾向于保持与参考模型相似的行为。

-   Sigmoid 函数<img src="https://www.zhihu.com/equation?tex=%5Csigma%28%5Ccenterdot%29" alt="\sigma(\centerdot)" class="ee_img tr_noresize" eeimg="1">用于将偏好响应与非偏好响应的对数几率（Log-Odds）转换为概率分数。 &#x20;

![图6.9 DPO损失函数](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/f2262ead4def9b48-image-67.png)
...
1.  构建训练用批次样本。
    ...
    1.  将prompt分别与chosen和refecjed文本进行拼接。

    1.  为了在训练时，忽略prompt的损失，对上述拼接后的文本进行mask操作。
...
-   <img src="https://www.zhihu.com/equation?tex=%5Cbeta" alt="\beta" class="ee_img tr_noresize" eeimg="1">值此处设置为0.1（较小值），以确保对齐后的模型，不会过度偏离参考模型，令模型响应结果更可对比。 &#x20;
...
![图6.10 训练loss变化](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/6659f99b71e6182b-image-76.png)

![图6.11 奖励差距变化](https://raw.githubusercontent.com/RobotZZZZZ/LLMs-from-scratch-CN/_md2zhihu_LLMs-from-scratch-CN_da24365c/从头构建大模型/29103bb8394fe2f9-image-75.png)
...
1.  其它的tokenize方案，教程中仅重点介绍了BPE，相关的技术还有WordPiece和SentencePiece等。

1.  位置编码相关技术，比如Llama中使用RoPE等。

1.  注意力机制的其它高效实现：

    1.  注意力机制的高效计算，如Flash Attention等。

    1.  在计算量和效果间进行平衡的注意力机制，如GQA、线性注意力等。

1.  LLM里的归一化技术，除了LayerNorm、RMSNorm外的其它方案。

1.  LLM里的激活函数，除了ReLU、GELU、SiLU外的激活方案。

1.  其它指令微调的优化策略，如LoRA等。
...
1.  LLM的Serving优化，
    ...
    1.  提升Serving的多样性和效果的技术等。

1.  LLM的reasoning的实现。

1.  主流开源模型的技术报告学习，特别是主要的优点和技术改进，如Deepseek系列、Qwen系列、Llama系列等。
...
-   从头构建大模型：https://github.com/rasbt/LLMs-from-scratch
    ...
    -   视频资料：https://www.youtube.com/playlist?list=PLPTV0NXA_ZSgsLAr8YCgCwhPIJNNtexWu
