...
![图2.7 计算上下文向量](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/378700b4a9412b75-image-16.png)
...
![图3.5 GELU和ReLU的对比](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/9c0edad0f046d4c1-image-31.png)
...
![图3.6 前向网络示例](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/6add5c1515eb7515-image-32.png)

![图3.7 瓶颈结构](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/dc06e7654f097e2d-image-33.png)
...
![图3.8 快捷连接示例](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/3bc2c79b58faf4bd-image-34.png)
...
![图3.9 Transformer模块](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/9a3af519ee0950a0-image-35.png)
...
![图3.10 GPT-2模型](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/38ab8f4d1b5409c0-image-36.png)
...
![图3.11 生成下一个词示意](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/3f5549400501264c-image-37.png)

![图3.12 生成下一个词详解](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/ac74df4b865dd861-image-59.png)

![图3.13 生成多个词的过程示意](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/282587045c1c6e5b-image-58.png)
...
![图4.1 该部分的内容介绍](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/b804bd65e739c441-image-45.png)
...
![图4.2 最大化目标token的概率](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/1eaa02619de72988-image-46.png)

![图4.3 交叉熵损失计算流程](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/0f267bf2d95ad802-image-47.png)
...
![图4.4 模型训练流程](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/63b772eaeec96509-image-48.png)
...
![图4.5 损失变化图](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/149102f32f1a385e-image-49.png)
...
![图4.6 学习率变化曲线](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/e0f80cad648b0a7f-image-50.png)
...
![图4.7 学习率预热+余弦衰减的学习率变化](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/bf43fb8d6acf0f69-image-51.png)
...
![图4.8 不同温度系数下的概率分布](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/5acec2288831031b-image-52.png)
...
![图4.9 Top-k采样示例](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/fc338eb98fb8d6b0-image-53.png)
...
![图4.10 GPT2 VS Llama2/3](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/34e28c6913cddd6e-image-54.png)
...
![图4.11 GQA示例](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/2a3aa21958774ed3-image-55.png)
...
![图4.12 Llama31和Llama32的区别](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/96250279a6f70ab9-image-56.png)
...
![图5.1 分类微调示例](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/31d6fbac715dc285-image-57.png)

![图5.2 指令微调示例](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/01f6b6f552479872-image-60.png)
...
![图5.3 分类数据处理流程](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/d6106594071b9285-image-61.png)

![图5.4 分类数据样本示例](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/ea0cc9efc8db3402-image-62.png)
...
![图5.5 训练损失](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/198fa3a642433bf5-image-63.png)
...
![图5.6 LoRA权重更新](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/4818905e38c408cb-image-64.png)
...
![图5.7 损失变化趋势](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/37c0faad634fc68b-image-73.png)
...
![图6.1 指令遵循示例-EN](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/1f46297b83a7bdde-image-74.png)

![图6.2 指令遵循示例-CN](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/2307c509148e3691-image-70.png)
...
![图6.3 指令微调的数据格式](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/e695d988e0129610-image-72.png)
...
![图6.4 指令微调数据处理流程](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/fba47bd1d1b37c5b-image-71.png)

![图6.5 忽略指令部分的损失（下述代码未实现）](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/400836fc38281565-image-68.png)
...
![图6.6 训练损失变化](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/40abc1341fcd9c70-image-69.png)
...
![图6.7 用户咨询购买笔记本电脑建议时LLM的两种回答](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/ca9f62752bce9276-image-65.png)

![图6.8 DPO的核心思想及其优化过程](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/e5014be4bf88b73f-image-66.png)
...
![图6.9 DPO损失函数](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/f2262ead4def9b48-image-67.png)
...
![图6.10 训练loss变化](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/6659f99b71e6182b-image-76.png)

![图6.11 奖励差距变化](https://cdn.jsdelivr.net/gh/RobotZZZZZ/LLMs-from-scratch-CN@_md2zhihu_LLMs-from-scratch-CN_da24365c/llm_scratch/29103bb8394fe2f9-image-75.png)
